...
class CrmClaimStage(models.Model):
    ...
    team_ids = fields.Many2many('crm.team', 'crm_team_claim_stage_rel',
                                ...
                                help="Link between stages and sales teams. "
                                     "When set, this limitate the current "
                                     "stage to the selected sales teams.")
    case_default = \
        fields.Boolean('Common to All Teams',
                       help="If you check this field, this stage will be "
                            "proposed by default on each sales team. "
                            "It will not assign this stage to existing "
                            "teams.")
...
class CrmClaim(models.Model):
    ...
    team_id = fields.Many2one('crm.team', 'Sales Team', oldname='section_id',
                              ...
                              help="Responsible sales team. "
                                   "Define Responsible user and Email account "
                                   "for mail gateway.",
                              default=lambda self:
    ...
    def create(self, vals):
        ...
        return super(CrmClaim, self.with_context(ctx=context)).create(vals,)
